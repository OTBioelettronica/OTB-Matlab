% Example script for direct communication with dueplus
%
...
EMG = 1;        % 1=EMG, 0=EEG
Mode = 0;       % 0=2Ch Diff, 1=2Ch Diff, 2=2Ch Diff, 3=2Ch Test
TCPPort = 54320;
...
for i = 1 : NumCycles
    ...
    hold off
    for j = 1 : NumChan-6
        %set(EMG, 'YData', data(j,:)*ConvFact + OffsetEMG*(j-1));
